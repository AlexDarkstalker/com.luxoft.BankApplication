...
import com.luxoft.bankapp.service.FeedService;
import com.luxoft.bankapp.service.LoadBankDataService;
...
public class BankApplication {
	...
	static String filePath = "C:\\labs\\BankApplication_initial\\feeds\\clients.feed";
	...
	public static void main(String[] args) {
		...
		LoadBankDataService.readFeedData(new File(filePath));
		printBankReport(bank);
		while (true) {
			...
			BankCommander.commands[command - 1].execute();
//			try {
//				FeedService.loadFeed(new File(FeedService.filePath + FeedService.fileName));
